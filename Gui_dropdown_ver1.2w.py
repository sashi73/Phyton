...
#end_program = Button(app, text='End', command=app.destroy(), width=9)
#end_program.grid (column=2,row=8,sticky=tk.N+tk.E )

"""
choice_beer = IntVar()
checkfamous = tk.Checkbutton(app, text = "Liquor", variable = choice_temples,  
                              onvalue = 1, offvalue = 0, width = 9
                              )
checkfamous.grid(column=0,row=7,sticky=tk.N+tk.E )
...
#choice_shopping = IntVar()
#checkfamous_a = tk.Checkbutton(app, text = "Shopping", variable = choice_shopping,  
#                              onvalue = 1, offvalue = 0, width = 10
#                              )
#checkfamous_a.grid(column=0,row=8,sticky=tk.N+tk.W )

#choice_temples = IntVar()
#checkfamous = tk.Checkbutton(app, text = "Temples", variable = choice_shopping,  
                              onvalue = 1, offvalue = 0, width = 7
                              )
#checkfamous.grid(column=0,row=6,sticky=tk.N+tk.E )

#choice_beach = IntVar()
checkfamous = tk.Checkbutton(app, text = "Beach", variable = choice_shopping,  
                              onvalue = 1, offvalue = 0, width = 9
                              )
checkfamous.grid(column=0,row=7,sticky=tk.N+tk.E )
"""
